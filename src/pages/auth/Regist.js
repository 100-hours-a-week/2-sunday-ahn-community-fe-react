...
const Regist = () => {
    ...
    const checkEmailDuplicate = async (email) => {
        try {
            const response = await fetch(`http://${process.env.REACT_APP_API_URL}/api/auth/email`, {
                method: "POST",
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://${process.env.REACT_APP_API_URL}/api/auth/regist`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
